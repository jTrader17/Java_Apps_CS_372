...
public class Calc {
    ...
    public static double calculate(String eq, MainActivity my, View v){
        vars.clear();
        pmpositions.clear();
        pmpositions.add(-1);
        i = 0;
    ...
    private static double expr(String eq, MainActivity my, View v){
        double left = term(eq, my, v);
        while(true){
            switch(curr_token){
                case "+":
                    pmpositions.add(i-1);
    ...
    private static double term(String eq, MainActivity my, View v){
        double left = prim(eq, my, v);
    ...
    private static double prim(String eq, MainActivity my, View v){
        switch (curr_token){
            case "1":
            case "2":
            case "3":
            ...
            default:
                ...
                if(!vars.containsKey(var)){
                    vars.put(var, new Variable(var, my, v));
                }
