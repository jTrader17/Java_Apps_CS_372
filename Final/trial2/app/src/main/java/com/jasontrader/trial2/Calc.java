...
public class Calc {
    ...
    public static double calculate(String eq, View vi, MainActivity my){
        vars.clear();
        pmpositions.clear();
        pmpositions.add(-1);
        i = 0;
        get_token(eq);
        return expr(eq, vi, my);
    }
    private static double expr(String eq, View vi, MainActivity my){
        double left = term(eq, vi, my);
        while(true){
            switch(curr_token){
                case "+":
                    pmpositions.add(i-1);
    ...
    private static double term(String eq, View vi, MainActivity my){
        double left = prim(eq, vi, my);
    ...
    private static double prim(String eq, View vi, MainActivity my){
        switch (curr_token){
            case "1":
            case "2":
            case "3":
            ...
            case "-":
                get_token(eq);
                return -prim(eq, vi, my);
            case "(":
                get_token(eq);
                double e = expr(eq, vi, my);
            ...
            default:
                ...
                if(!vars.containsKey(var)){
                    vars.put(var, new Variable(var, vi, my));
                }
